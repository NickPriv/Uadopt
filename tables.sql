...
INSERT INTO Pet values ('French Bulldog', 3 ,3, 3, 3, 4, 4, 4, 3, 4, 2, 2, 'The one-of-a-kind French Bulldog, with his large bat ears and even disposition, is one of the world''s most popular small-dog breeds, especially among city dwellers. The Frenchie is playful,alert, adaptable, and completely irresistible. French Bulldogs can have various health problemsand not the best life expectancy.', '"http://www.dogbreedchart.com/img/french-bulldog.jpg"');
INSERT INTO Pet values ('Boston Terrier', 3, 4, 4, 4, 5, 5, 4, 3, 4, 4, 2, 'Boston Terriers are compact, short-tailed, well-balanced little dogs weighing no more than 25 pounds. The stylish \"tuxedo\" coat can be white and either black, brindle, or seal (dark brown). The head is square, the muzzle is short, and the large, round eyes can shine with kindness, curiosity, or mischief. Ever alert to their surroundings, Bostons move with a jaunty, rhythmic step.', '"http://www.dogbreedchart.com/img/boston-terrier.jpg"');
...
SELECT match.breed, pet.description, pet.photo
FROM match 
