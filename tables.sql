...
INSERT INTO Pet values ('Poodle', 2, 4, 5, 1, 5, 3, 4, 4, 5, 2, 4, 'Poodle is a group of formal dog breeds : Standard, Miniature, and Toy Poodle. This breed is very intelligent, energetic and sociable. Due to its high energy level, potential owners should have a lifestyle that matches the breed\'s energy level. A bored Poodle can prove to be fairly destructive.', '"http://www.dogbreedchart.com/img/poodle.jpg"');    
INSERT INTO Pet values ('Pomeraninan', 5, 3, 4, 4, 2, 2, 3, 4, 4, 3, 1,    'Pomeranian is a small, playful and lively breed. This breed is typically friendly and playful, but can get aggressive with other dogs to try to prove themselves. Pomeranian is a fairly high maintenance breed, and doesn\'t get along too well with people and other dogs.', '"http://www.dogbreedchart.com/img/pomeranian.jpg"');      
INSERT INTO Pet values ('Old  English Sheepdog', 1, 4, 4, 5, 4, 5, 4, 4, 3, 4, 4,    'Old English Sheepdog is a large breed known for its intelligence, gentleness, adaptability, and its clownish energy. This breed standard describe the ideal Old English Sheepdog as never  being nervous or aggressive which makes the breed an excellent family dog. However, maintenance can be really high due to its dense coat.', '"http://www.dogbreedchart.com/img/old-english-sheepdog.jpg"');       
INSERT INTO Pet values ('Newfoundland', 4, 3, 4, 5, 5, 5, 4, 4, 5, 1, 5,    'Newfoundland is a large, working breed. Newfoundland (or Newfie) is an excellent family dog due to its calm and docile nature and its friendliness to people and other dogs. Nonetheless, its size and strength makes Newfie an excellent guard dog when needed. However, maintenance is something to think about when considering this breed.', '"http://www.dogbreedchart.com/img/newfoundland.jpg"');     
INSERT INTO Pet values ('Mastiff', 2, 3, 2, 3, 5, 5, 4, 3, 3, 3, 5,    'Mastiff is one of the largest breeds there is. Contrary to its intimidating look, Mastiff is a very friendly, and gentle breed. Although not recommended for families with small children, Mastiff get along really well with kids because of its high tolerance. However, due to its sheer size and strength, prior experience is recommended.', '"http://www.dogbreedchart.com/img/mastiff.jpg"');       
INSERT INTO Pet values ('Maltese', 2, 3, 4, 2, 3, 3, 3, 3, 4, 3, 1,    'Maltese is a small breed, bred for companionship. Maltese are playful, and energetic. Even in their older days, Maltese\'s playful demeanor still stays constant. However, Maltese are known to be fairly high-maintenance, new owners should keep this in mind when considering a new pet.', '"http://www.dogbreedchart.com/img/maltese.jpg"');     
INSERT INTO Pet values ('Labradoodle', 2, 5, 4, 5, 4, 4, 5, 4, 4, 4, 4,    'Labradoodle is a mixed breed between the Labrador Retriever and Poodle. Most, but not all, labradoodles are hypoallergenic which is the quality most sought after when people consider this breed. Because of the breed\'s variation, its temperament also varies, but Labradoodle is believed to have similar  excellent temperament as Labrador Retriever.', '"http://www.dogbreedchart.com/img/labradoodle.jpg"');    
INSERT INTO Pet values ('Labrador Retriever', 4, 5, 5, 5, 5, 4, 5, 4, 5, 3, 4,    'Labrador Retriever is a large, pleasant, outgoing, and very trainable breed. Because of their excellent temperament, Labrador is a great family dog. Labrador has many lines (bred for athleticism, or temperament). Because of the breed\'s flexibility Labradors are used as family pet, police K9, service dogs, etc.', '"http://www.dogbreedchart.com/img/labrador-retriever.jpg"');    
INSERT INTO Pet values ('Havanese', 2, 3, 4, 4, 4, 4, 4, 5, 5, 3, 2,    'Havanese is a small dog that originated from Cuba. Havanese are known to be outgoing, intelligent, friendly and very playful. They have a long, silky double coat which requires daily grooming. Havanese has moderate exercise needs which can be satisfied with short daily walks, however, owners who look for a hyperactive breed to accommodate their energetic lifestyle should avoid this breed.', '"http://www.dogbreedchart.com/img/havanese.jpg"');     
INSERT INTO Pet values ('Jack Russell Terrier', 4, 5, 5, 3, 4, 2, 4, 4, 4, 4, 2,    'Jack Russell is a small, yet very energetic breed and requires a high level of exercise and stimulation.  Coupled with their high energy level is their friendliness to people and other dogs, making the Jack Russell a terrific for outgoing, active owners who are looking for a companion that compliments their lifestyle.', '"http://www.dogbreedchart.com/img/jack-russell-terrier.jpg"'); 
